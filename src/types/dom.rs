...
use types::{
    VIRTUAL_AUX_CLICK, VIRTUAL_CLICK, VIRTUAL_CONTEXT_MENU, VIRTUAL_DBL_CLICK, VIRTUAL_KEY_DOWN,
    VIRTUAL_KEY_PRESS, VIRTUAL_KEY_UP, VIRTUAL_MOUSE_DOWN, VIRTUAL_MOUSE_MOVE, VIRTUAL_MOUSE_UP,
